function SectionOfferAria() {
    return (
        <section class="offer_area height-700 section_padding_100 bg-img" style={{ backgroundImage: "url(assets/img/bg-img/bg-5.jpg)" }}>
...
export default SectionOfferAria;