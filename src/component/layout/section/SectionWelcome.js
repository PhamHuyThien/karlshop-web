    ...
    return (
        <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <div class="single_slide height-800 bg-img background-overlay" style={{ backgroundImage: "url(assets/img/bg-img/bg-1.jpg)" }}>
                ...
                <div class="single_slide height-800 bg-img background-overlay" style={{ backgroundImage: "url(assets/img/bg-img/bg-4.jpg)" }}>
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                ...
                <div class="single_slide height-800 bg-img background-overlay" style={{ backgroundImage: "url(assets/img/bg-img/bg-2.jpg)" }}>
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
